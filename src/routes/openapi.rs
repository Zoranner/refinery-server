    ...
    Json(json!({
        ...
        "components": {
            ...
            "schemas": {
                ...
                "SearchResponse": { "type": "object", "required": ["query", "page", "results", "pagination", "diagnostics"], "properties": { "query": { "type": "string" }, "page": { "type": "integer" }, "results": { "type": "array", "items": { "$ref": "#/components/schemas/SearchResult" } }, "pagination": { "$ref": "#/components/schemas/SearchPagination" }, "diagnostics": { "$ref": "#/components/schemas/SearchDiagnostics" } } },
                "SearchPagination": { "type": "object", "required": ["requested_page", "has_more"], "properties": { "requested_page": { "type": "integer", "minimum": 1 }, "has_more": { "type": "boolean", "nullable": true } } },
                "SearchDiagnostics": { "type": "object", "required": ["source_status", "warnings"], "properties": { "source_status": { "type": "string", "example": "ok" }, "warnings": { "type": "array", "items": { "type": "string" } } } },
                ...
                "ContentResponse": { "type": "object", "required": ["requested_url", "final_url", "resource_kind", "content_type", "markdown", "links", "offset", "truncated", "warnings"], "properties": { "requested_url": { "type": "string", "format": "uri" }, "final_url": { "type": "string", "format": "uri" }, "resource_kind": { "type": "string", "enum": ["html", "text", "pdf", "image", "unknown"] }, "content_type": { "type": "string" }, "title": { "type": "string", "nullable": true }, "markdown": { "type": "string" }, "links": { "type": "array", "items": { "$ref": "#/components/schemas/Link" } }, "offset": { "type": "integer" }, "next_offset": { "type": "integer", "nullable": true }, "truncated": { "type": "boolean" }, "warnings": { "type": "array", "items": { "type": "string" } } } },
